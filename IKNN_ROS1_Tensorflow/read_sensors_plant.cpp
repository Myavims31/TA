...
{
    // Untuk Asli
    joint_1 = std::round(msg.position.at(0)*1000)/1000;
    joint_2 = std::round(msg.position.at(1)*1000)/1000;
    joint_3 = std::round(msg.position.at(2)*1000)/1000;
    joint_4 = std::round(msg.position.at(3)*1000)/1000;
...
{
  ros::init(argc, argv, "sensors_plant");
  ros::NodeHandle n;
